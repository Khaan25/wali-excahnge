        ...
        <Navbar/>
           <div className="container help-page">
                <div className="row py-5">
                    <h1 className="text-center mb-3" data-aos="fade-down" data-aos-delay="300">Help</h1>
                    <div className="col-lg-6 col-md-8 col-10 mx-auto py-4 help-section" data-aos="fade-up" data-aos-delay="300">
                    {/* Request Reset Password Button */}
                    <Link  to={"/help"}>
                    <h5 className="help-btn text-center btn-blue py-2 fw-bold">Request Reset Password
                    </h5>
                    </Link>
                    {/* Reset password request error and success message */}
                    <p className=" excetion-msg text-center mt-5 text-success">Reset Password code is sent to Your email. </p>
                    {/* <p className=" excetion-msg text-center mt-5 text-danger">Something went wrong try again in a while.</p> */}
                    </div>
                </div>
                <div className="row py-5">
                    <div className="col-lg-6 col-md-8 col-10 mx-auto py-4 help-section" data-aos="fade-down" data-aos-delay="300">
                    ...
                    <div className="reset-code mb-3">
                          ...
                          <br />
                          <input className="w-100 mt-1" id="reset-code"  type="" name="pin" pattern="[0-9]{6}" maxlength="6" />
                          {/* Excetion message for valid or invalid reset code  */}
                          <span className="text-success excetion-msg">Success! Enter New Password Below</span>
                          <br />
                          <span className="text-danger excetion-msg">Failure! Invalid Password Reset Code</span>
                        </div>
                    </form>
                     <form action="/help">
